...
public class Triangle {
    ...
    public Triangle(Triangle prototype) {
        super(prototype);
        if(prototype != null) {
          this.point1 = new Point(prototype.point1.x, prototype.point1.y);
          this.point2 = new Point(prototype.point2.x, prototype.point2.y);
          this.radius = new Point(prototype.point3.x, prototype.point3.y);
        }
    }
    ...
    private double getSideLength(Point point1, Point point2) {
        double size = Math.pow(point1.x - point2.x) + Math.pow(point1.y - point2.y);
...
public abstract class Figure {
    ...
    public Figure(Figure prototype) {
        ...
        this.borderColor = prototype.getBorderColor();
    }
